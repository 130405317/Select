...
public class StudentController {
	...
	@ResponseBody
	public Map<String, Object> getStudentById(HttpServletRequest request, HttpServletResponse response) {
		Map<String, Object> map = null;
		Map<String, Object> param = FormDataCollectUtil.getInstance().getFormData(request);
		map = studentService.getStudentById(param);
		return map;
	}
	...
	@ResponseBody
	public List<Map<String, Object>> getStudentsByClass(HttpServletRequest request, HttpServletResponse response) {
		List<Map<String, Object>> list = null;
		Map<String, Object> param = FormDataCollectUtil.getInstance().getFormData(request);
		list = studentService.getStudentsByClass(param);
		return list;
	}
	...
	public void updateStudent(HttpServletRequest request, HttpServletResponse response) {
		Map<String, Object> param = FormDataCollectUtil.getInstance().getFormData(request);
		if ("s_birthday".equals(param.get("type"))) {
	 ...
	 */
	@CrossOrigin(origins = "http://127.0.0.1:8020", maxAge = 3600, methods = { RequestMethod.POST })
	@RequestMapping("stu_img_upload")
	public String stuSpringUpload(HttpServletRequest request) throws IllegalStateException, IOException {
